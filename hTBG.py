...
if __name__ == '__main__':
    ...
    htbg_parameters = {
        ...
        "p_save_true": float(arguments['--p_save_true']),
        "p_save_false": float(arguments['--p_save_false']),
        "t_summary": float(arguments['--t_summary']),
        "t_alpha": float(arguments['--t_alpha']),
        "t_beta": float(arguments['--t_beta']),
